...
### **1**.   
  Cuántos bits hay en 32 KB? ¿Y en 64 MB?  ¿Y en 4 GB?
     ...
     RESPUESTA: En 32 KB hay 262144 bits. En 64 MB hay 536870912 bits. En 4 GB hay 34359738368 bits
...
Una computadora tiene 36 K palabras de memoria principal (K informático, no decimal!!), y está estructurada en palabras de 32 bits? ¿Cuántos caracteres caben en dicha memoria?
     ...
     RESPUESTA: Cabrían unos 147456 bytes (caracteres)
...
|hexadecimales:|37F|0,0AC54| 1101111111  |  0,00001010110001010100   |
...
16 bits -> 65536 caracteres diferentes
...
(Se trata de códigos de control de comunicaciones (telégrafo) y de impresora)
...
- a) Signo y magnitud.     
  - RESPUESTA: +100=0110 0100, -127=1111 1111, +255=no se puede, -128=no se puede
- b) Complemento a 1.     
  - RESPUESTA: +100=0110 0100, -127=1000 0000, +255=no se puede, -128=no se puede
- c) Complemento a 2.      
  - RESPUESTA: +100=0110 0100, -127=1000 0001, +255=no se puede, -128=1000 0000
- d) Sesgada (desplazada).
  - RESPUESTA: +100=1110 0100, -127=0000 0001, +255=no se puede, -128=0000 0000
...
-  Sin signo.
 ...
 - BCD.
     - RESPUESTA: 10101110=no valida; 01111011=no valida; 10000000=80
