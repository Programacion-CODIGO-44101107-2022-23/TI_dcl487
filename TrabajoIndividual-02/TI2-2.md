...
- (30,2)<sub>5 </sub> 
         ...
         Respuesta: (1111,011)2

- (30,2)<sub>8 </sub> 
  
       Respuesta: (11000,010)2
...
-	Signo y magnitud.
              ...
              Respuesta: +400 -> 0001 1001 0000 / -500 -> 1001 1111 0100 / +2048 -> Fuera de rango / -2048 -> No se puede representar

-	Complemento a 1.

              Respuesta: +400 -> 0001 1001 0000 / -500 -> 1110 0000 1011 / +2048 -> Fuera de rango / -2048 -> No se puede representar

-	Complemento a 2.

              Respuesta: +400 -> 0001 1001 0000 / -500 -> 1110 0000 1100 / +2048 -> Fuera de rango / -2048 -> 1000 0000 0000

-	Sesgada (desplazada).

              Respuesta: +400 -> 1001 1001 0000 / -500 -> 0110 0000 1100 / +2048 -> Fuera de rango / -2048 -> 0000 0000 0000
...
-	Indicar a qué números decimales se corresponden los siguientes números (expresados en representación interna): 7F800001, 80400000
              ...
              Respuesta: 7F800001 -> NaN / 80400000 -> -0,5*2-126
...
-	Calcular la precisión de esta representación, esto es, la diferencia entre un nº real cualquiera (diferente de cero y en representación normalizada) y el número real inmediatamente superior que es posible representar.
              ...
              Respuesta: 2-232E=0,110-6*2E -> aproximadamente las 6 primeras cifras del número son exactas
